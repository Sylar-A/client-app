		...
		<DayPicker
			...
			classNames={{
				...
				cell:
					...
					"[&:has([aria-selected].day-outside)]:bg-zinc-100/50 [&:has([aria-selected])]:bg-zinc-100 " +
					"first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md " +
					"focus-within:relative focus-within:z-20 dark:[&:has([aria-selected].day-outside)]:bg-zinc-800/50 " +
					"dark:[&:has([aria-selected])]:bg-zinc-800",
				day: cn(
				...
				day_today: "bg-zinc-100 dark:bg-zinc-700 dark:text-zinc-100",
				day_outside:
