...
>(({ className, ...props }, ref) => (
	<th
		ref={ref}
		className={cn(
			"border-2 h-14 text-center align-middle font-medium text-zinc-500 bg-zinc-100 dark:bg-black " +
...
>(({ className, ...props }, ref) => (
	<td
		ref={ref}
		className={cn(
			"border-2 p-2 text-center align-middle [&:has([role=checkbox])]:pr-0 dark:border dark:border-zinc-500",
			className,
		)}
		{...props}
	/>
...
>(({ className, ...props }, ref) => (
	<caption
		ref={ref}
		className={cn(
			"mt-2 mb-2 text-xl text-zinc-500 dark:text-zinc-400",
			className,
		)}
		{...props}
	/>
