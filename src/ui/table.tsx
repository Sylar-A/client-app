...
>(({ className, ...props }, ref) => (
	<div className="relative w-full overflow-auto">
		<table
			ref={ref}
			className={cn("w-full caption-top text-sm border", className)}
			{...props}
		/>
	</div>
));
...
>(({ className, ...props }, ref) => (
	<th
		ref={ref}
		className={cn(
			"border-2 h-14 px-4 text-center align-middle font-medium text-zinc-500 bg-zinc-100 dark:bg-black " +
...
>(({ className, ...props }, ref) => (
	<td
		ref={ref}
		className={cn(
			"border-2 p-4 text-center align-middle [&:has([role=checkbox])]:pr-0 dark:border dark:border-zinc-500",
			className,
		)}
		{...props}
	/>
...
>(({ className, ...props }, ref) => (
	<caption
		ref={ref}
		className={cn(
			"mt-4 mb-4 text-xl text-zinc-500 dark:text-zinc-400",
			className,
		)}
		{...props}
	/>
